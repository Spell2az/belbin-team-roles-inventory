export const teamroles = [
  {
    name: 'Implementer',
    description: ' is the practical organizer within the team. Disciplined, orderly and task-oriented. Implementer puts plans and ideas into easily executable tasks. He/she can be a little too practical and conservative when the usefulness of new ideas is not immediately clear.',
  ...
  },
  {
    ...
    name: 'Plant',
    description: ' is the creative thinker of the team. Innovative and original. A free spirit who needs space to fantasize about new and surprising solutions to complex problems. Plant is not always practical and sometimes misses what others require from him/her.',
    ...
    name: 'Shaper',
    description: ' is driven, passionate and willful. He/she has a strong urge to perform, looks for challenges and gets things going. Shaper makes sure deadlines are made and goals are met, one way or the other. He/she can get frustrated and react angrily or emotionally.',
    ...
    name: 'Teamworker',
    description: ' is the most sensitive member of the team, helpful, accommodating and focused on creating a pleasant atmosphere and sense of togetherness. He/she prefers balance and harmony and is close to others. Teamworker has difficulty with conflict and may have trouble taking decisions at critical times.',
